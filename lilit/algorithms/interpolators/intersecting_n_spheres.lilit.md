...
```cpp
// @+'interpolators'
template<typename Scalar, typename SVector, typename PVector>
struct IntersectingNSpheresInterpolator
{
    struct AttribIn  {};
    struct AttribOut { Scalar r = 0, d = 0, w = 0; };
    struct UniformIn { demo_changed = true; }
    struct UniformOut { Scalar r_q; }
