...
namespace
{
    ...
    template<typename ViewEachPack>
    Component::Position destination(ViewEachPack& pack)
    {
        auto &&[entity, demo, src, dst] = pack;
        return dst;
    }
...
namespace System
{
    Component::Position source_to_position(entt::registry& registry, Component::Demo::Source q)
    {
        using Src = Component::Demo::Source;
        using Dst = Component::Position;
